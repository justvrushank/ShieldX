...
const TERMS_SECTIONS = [
  {
    title: '1. What ShieldX covers',
    content: `ShieldX provides parametric income insurance for platform-based delivery workers in India. Coverage is activated automatically when any of these trigger events occur in your registered delivery zone:
...
Claims may be flagged for manual review if fraud signals exceed threshold. Resolution within 24 hours.`,
  },
  {
    ...
    content: `ShieldX uses a 7-signal fraud detection system including GPS verification, activity checks, multi-worker correlation, and device consistency.
...
ShieldX is a product of Team SentinelX, built as part of Guidewire DEVTrails 2026. This is a prototype product and not currently regulated by IRDAI. Full regulatory compliance is being pursued through the IRDAI Regulatory Sandbox.`,
  },
]
      ...
      <div style={{ padding: '16px 16px 80px' }}>
        ...
        <div style={{
          ...
          <p style={{
            ...
            By using ShieldX, you agree to these terms.
        ...
        <p style={{
          ...
          <a
            href="mailto:ShieldX@sentinelx.in"
            style={{ color: '#D97757' }}
          >
            ShieldX@sentinelx.in
          </a>
        </p>
      </div>
    </div>
