    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: 'var(--bg-secondary)' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--text-tertiary)', fontFamily: 'Inter' }}>Checking your zone...</p>
        </div>
    ...
    >
      ...
      <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <div style={{
          ...
          {[
            { label: 'Payouts (30d)', value: String(data?.recent_claims_30d ?? 0) },
            { label: 'Events in zone', value: String(data?.historical_trigger_events ?? 0) },
          ].map(stat => (
