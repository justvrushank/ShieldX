...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (showAlert && zoneAlert && Notification.permission === 'granted') {
      new Notification('ShieldX · Flood Alert', {
        body: `${zoneAlert.probability}% flood chance in ${zoneAlert.zone}. Stay safe — your coverage is watching.`,
        icon: '/favicon.ico',
      })
    }
  }, [showAlert, zoneAlert])
      ...
      <motion.div variants={stagger} animate="animate" className="px-4 mt-3 flex flex-col gap-3">
              ...
              >
                <div>
                  <p style={{
                    ...
                    💰 ₹{newClaimAlert.amount} paid to your UPI
                  </p>
                  <p style={{
                    fontSize: 12, fontFamily: 'Inter',
                    color: 'rgba(255,255,255,0.8)', margin: 0,
                  }}>
                    {newClaimAlert.trigger_type || 'Flood'} payout approved · Tap to view
                  </p>
                </div>
                <span style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                ...
                <div style={{ flex: 1 }}>
                  <p style={{ fontSize: 13, fontWeight: 600, fontFamily: 'Inter', color: 'var(--text-primary)', margin: '0 0 4px' }}>
                    {wellnessData.score >= 80 ? 'Great work!' : wellnessData.score >= 60 ? 'Looking good' : wellnessData.score >= 40 ? 'Room to improve' : 'Needs attention'}
                  </p>
        ...
        <motion.div variants={fadeUp}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <p style={{ fontSize: 12, color: 'var(--text-secondary)', fontFamily: 'Inter', margin: 0 }}>
              Your delivery level affects payout amount
            </p>
          </div>
        </motion.div>
        ...
        <motion.div variants={fadeUp}>
          <div className="flex items-center justify-between mb-2">
            ...
            {paidClaims.length > 0 && (
              <button className="text-[13px] text-brand font-semibold font-body" onClick={() => navigate('/claims')}>View all →</button>
            )}
          </div>
          ...
          <>
            ...
            >
              ...
              <p style={{
                ...
                Get covered for floods, outages, and curfews. We monitor 24/7 and pay you automatically — no forms needed.
              </p>
