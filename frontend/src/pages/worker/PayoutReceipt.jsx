...
const PayoutReceipt = () => {
  ...
  const downloadReceipt = () => {
    ...
    const html = `
      ...
      <html>
      <head>
        <title>ShieldX Payout Receipt</title>
        <style>
      ...
      <body>
        <div class="header">
          <div style="font-size:22px; font-weight:800; color:#D97757;">ShieldX</div>
    ...
    a.href = url
    a.download = `ShieldX-Payout-${txnId}.html`
    a.click()
        ...
        >
          ...
          <div style={{
            ...
            <div style={{ 
              ...
              Tell your delivery friends about ShieldX
            </div>
          </div>
