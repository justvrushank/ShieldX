      ...
      <div style={{ padding: '16px' }}>
        ...
        {zoneHistory && (
          <div style={{
            ...
            {/* ShieldX impact — THE CONVERSION LINE */}
            <div style={{
              ...
              <div style={{ fontSize: '11px', color: '#4ADE80', fontWeight: '700', marginBottom: '6px' }}>
                💚 IF YOU HAD ShieldX IN 2024
              </div>
              <div style={{ fontSize: '15px', fontWeight: '700', color: '#F4F4F6', marginBottom: '4px' }}>
                You would have received ₹{zoneHistory.ShieldX_impact.would_have_paid_2024.toLocaleString()} automatically
              </div>
              <div style={{ fontSize: '12px', color: '#8A8A8F' }}>
                ...
                &nbsp;·&nbsp; Premium cost: ₹{zoneHistory.ShieldX_impact.annual_premium_cost}
              </div>
              {zoneHistory.ShieldX_impact.net_benefit_2024 > 0 && (
                <div style={{ 
                  fontSize: '13px', color: '#4ADE80', fontWeight: '600', marginTop: '6px' 
                }}>
                  Net benefit: +₹{zoneHistory.ShieldX_impact.net_benefit_2024.toLocaleString()} in your pocket
                </div>
              )}
            </div>
          </div>
        ...
        <div style={{ background: 'var(--bg-card)', borderRadius: 16, padding: 18, border: '1px solid var(--border-light)', marginBottom: 18 }}>
          ...
          <p style={{ fontFamily: 'Bricolage Grotesque', fontSize: 20, fontWeight: 800, color: 'var(--text-primary)', margin: '0 0 10px' }}>
            Zone risk × your daily income × days covered
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8, marginBottom: 10 }}>
            <div style={{ background: 'var(--bg-secondary)', borderRadius: 10, padding: '10px 12px' }}>
              <p style={{ fontSize: 10, color: 'var(--text-tertiary)', fontFamily: 'Inter', margin: 0 }}>Zone risk</p>
            ...
            <div style={{ background: 'var(--bg-secondary)', borderRadius: 10, padding: '10px 12px' }}>
              <p style={{ fontSize: 10, color: 'var(--text-tertiary)', fontFamily: 'Inter', margin: 0 }}>Daily income</p>
              <p style={{ fontSize: 15, fontWeight: 700, color: 'var(--text-primary)', fontFamily: 'Inter', margin: '4px 0 0' }}>Rs{avgIncome}</p>
            </div>
            <div style={{ background: 'var(--bg-secondary)', borderRadius: 10, padding: '10px 12px' }}>
              <p style={{ fontSize: 10, color: 'var(--text-tertiary)', fontFamily: 'Inter', margin: 0 }}>Days covered</p>
          ...
          <p style={{ fontSize: 12, color: 'var(--text-secondary)', fontFamily: 'Inter', margin: 0 }}>
            Fair price estimate: Rs{formulaPremium}. Your final price may vary slightly by plan and zone rules.
          </p>
        </div>
