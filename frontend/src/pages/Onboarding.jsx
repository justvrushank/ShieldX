...
const TOUR_STEPS = [
  {
    ...
    bg: '#FDF1ED',
    accent: '#D97757',
    title: 'Welcome to ShieldX',
    headline: 'ShieldX is now monitoring your zone.',
    body: 'Real-time parametric risk engine activated. We continuously scan IMD signals, platform health, and curfew feeds — executing payouts automatically when a verified event fires.',
    action: 'Show me how',
  },
  {
    id: 'triggers',
    ...
    headline: '3 signal classes. Continuous scanning.',
    body: 'ShieldX ingests IMD SACHET flood alerts, Downdetector outage signals for Zepto/Swiggy/Blinkit, and government curfew feeds — polled every 15 minutes from 4 independent sources.',
    visual: 'triggers',
    action: 'Got it',
  },
  {
    ...
    headline: 'Activity signal evaluated automatically.',
    body: 'Before executing, the system checks your last completed delivery timestamp. Active within 6 hours — full payout. Active within 2 hours — immediate execution. No input from you needed.',
    visual: 'verification',
    action: 'Understood',
  },
  {
    ...
    headline: 'UPI execution in under 2 hours.',
    body: 'Once fraud evaluation clears, Razorpay executes the payout directly to your UPI. No bank forms, no wait, no calls. Push notification fires the moment transfer is initiated.',
    visual: 'payout',
    action: 'Perfect',
  },
  {
    ...
    headline: 'Reliability index drives your premium.',
    body: 'Your index reflects delivery consistency, activity recency, and clean claim history. Index above 0.75 → 15% automatic premium discount — recalculated every renewal cycle.',
    visual: 'score',
    action: 'Got it',
  },
  {
    ...
    headline: 'Command center. All live data.',
    body: 'Your dashboard surfaces active policy status, zone intelligence feed, predictive risk forecast, and your execution decision log. All modules update in real time.',
    visual: 'pages',
