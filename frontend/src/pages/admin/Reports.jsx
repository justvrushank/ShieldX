    ...
    try {
      switch (reportId) {
        case 'claims_summary': {
          ...
          exportToExcel(rows, 'ShieldX_Claims_Summary', 'Claims')
          break
        }
        ...
        case 'revenue_report': {
          ...
          exportToExcel(merged, 'ShieldX_Revenue_Report', 'Revenue')
          break
        }
        ...
        case 'fraud_analysis': {
          ...
          exportToExcel(fraudClaims, 'ShieldX_Fraud_Analysis', 'Fraud')
          break
        }
        ...
        case 'worker_portfolio': {
          ...
          exportToExcel(Object.values(workerMap), 'ShieldX_Worker_Portfolio', 'Workers')
          break
        }
