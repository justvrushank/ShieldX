...
const WORDS = ['शील्डX', 'ਸ਼ીલ્X', 'శీల్X', 'शेल्X', 'ShieldX']
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, marginTop: 24 }}>
        ...
        <p style={{ fontSize: 10, fontFamily: 'Inter, sans-serif', color: 'rgba(255,255,255,0.3)', letterSpacing: '2px', textTransform: 'uppercase', margin: 0 }}>Initializing</p>
      </div>
    </motion.div>
  )
}
